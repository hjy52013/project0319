...
import com.hhchaos.ftp.filetransfer.Activity.MainActivity;
import com.hhchaos.ftp.filetransfer.Server.MyLog;
import com.hhchaos.ftp.filetransfer.Server.ProxyConnector;
import com.hhchaos.ftp.filetransfer.Server.SessionThread;
import com.hhchaos.ftp.filetransfer.Server.TcpListener;
import com.hhchaos.ftp.filetransfer.Server.UiUpdater;
import com.hhchaos.ftp.filetransfer.Server.Util;
...
//	protected static InetAddress serverAddress = null;
	...
	private boolean loadSettings() {
		...
		acceptNet = settings.getBoolean(MainActivity.ACCEPT_NET,
									    Defaults.acceptNet);
		acceptWifi = settings.getBoolean(MainActivity.ACCEPT_WIFI,
										 Defaults.acceptWifi);
		fullWake = settings.getBoolean(MainActivity.STAY_AWAKE,
										 Defaults.stayAwake);
		
		// The username, password, and chrootDir are just checked for sanity
		String username = settings.getString(MainActivity.USERNAME, "username");
		String password = settings.getString(MainActivity.PASSWORD, "password");
		String chrootDir = settings.getString(MainActivity.CHROOTDIR,
				Defaults.chrootDir);
